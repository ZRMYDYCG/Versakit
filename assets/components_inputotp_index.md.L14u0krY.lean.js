import{d as c,p as r,b,o as p,k as a,B,c as _,j as o,a5 as m,G as l,a as u,a6 as v,w as s}from"./chunks/framework.B3Jz-8p0.js";import{y as V}from"./chunks/theme.DKFx6c4r.js";import{d as f,f as h}from"./chunks/index.BbNYUtVF.js";const C=`<script setup lang="ts">
import { ref } from 'vue'
...
`,D=c({__name:"disabled",setup(d){const t=r("1234");return(i,e)=>(p(),b(a(V),{disabled:"",modelValue:t.value,"onUpdate:modelValue":e[0]||(e[0]=n=>t.value=n)},null,8,["modelValue"]))}}),W=`<script setup lang="ts">
import { ref } from 'vue'
import { VerInputOtp } from '@versakit/ui'
...
<style></style>
`,X=c({__name:"placeholder",setup(d){const t=r("");return(i,e)=>(p(),b(a(V),{placeholder:"*",modelValue:t.value,"onUpdate:modelValue":e[0]||(e[0]=n=>t.value=n)},null,8,["modelValue"]))}}),A=`<script setup lang="ts">
import { ref } from 'vue'
import { VerInputOtp } from '@versakit/ui'
