import{X as m}from"./chunks/theme.C6BEB8ch.js";import{d as c,p as h,b as v,o as p,k as n,B as f,c as b,j as o,G as l,a as u,w as s}from"./chunks/framework.CYu56ZLI.js";import{Q as i}from"./chunks/index.B77M7Ljq.js";const V=`<script setup lang="ts">
import { ref } from 'vue'
...
<style></style>
`,C=c({__name:"placeholder",setup(d){const a=h("");return(t,e)=>(p(),v(n(m),{placeholder:"*",modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=r=>a.value=r)},null,8,["modelValue"]))}}),X=`<script setup lang="ts">
import { ref } from 'vue'
import { VerInputOtp } from '@versakit/ui'
...
<style></style>
`,W=c({__name:"length",setup(d){const a=h("");return(t,e)=>(p(),v(n(m),{length:4,modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=r=>a.value=r)},null,8,["modelValue"]))}}),A=`<script setup lang="ts">
import { ref } from 'vue'
import { VerInputOtp } from '@versakit/ui'
