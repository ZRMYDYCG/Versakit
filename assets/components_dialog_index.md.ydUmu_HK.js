import{d as h,p,b as W,o as v,w as a,G as l,k as o,a as i,j as d,_ as k,c as y,B as D,a5 as f,aw as B,a6 as g}from"./chunks/framework.B3Jz-8p0.js";import{x as r,s as m,q as C,J as x}from"./chunks/theme.DKFx6c4r.js";import{d as V,f as c}from"./chunks/index.BbNYUtVF.js";const Z=`<template>
  <ver-row>
...
<\/script>
`,w=h({__name:"header",setup(b){const n=p(!1);return(s,e)=>(v(),W(o(C),null,{default:a(()=>[l(o(r),{onClick:e[0]||(e[0]=t=>n.value=!0)},{default:a(()=>e[2]||(e[2]=[i("点击打开对话框")])),_:1}),l(o(m),{modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=t=>n.value=t),closeIcon:"ep:close"},{title:a(()=>e[3]||(e[3]=[d("div",{class:"title"},[d("h4",null,"This is a custom header!")],-1)])),_:1},8,["modelValue"])]),_:1}))}}),A=`<template>
  <ver-row>
    <ver-button @click="dialogVisible = true">点击打开对话框</ver-button>
...
`,G=h({__name:"content",setup(b){const n=p(!1),s=p(!1);return(e,t)=>(v(),W(o(C),null,{default:a(()=>[l(o(r),{onClick:t[0]||(t[0]=u=>n.value=!0)},{default:a(()=>t[5]||(t[5]=[i("点击打开对话框")])),_:1}),l(o(r),{onClick:t[1]||(t[1]=u=>s.value=!0)},{default:a(()=>t[6]||(t[6]=[i("点击打开对话框")])),_:1}),l(o(m),{modelValue:n.value,"onUpdate:modelValue":t[2]||(t[2]=u=>n.value=u),title:"测试"},{default:a(()=>t[7]||(t[7]=[d("p",null,"这是一个信息",-1)])),_:1},8,["modelValue"]),l(o(m),{modelValue:s.value,"onUpdate:modelValue":t[4]||(t[4]=u=>s.value=u),title:"表单",closeIcon:"ep:close"},{footer:a(()=>[l(o(r),null,{default:a(()=>t[8]||(t[8]=[i("取消")])),_:1}),l(o(r),{type:"primary",onClick:t[3]||(t[3]=u=>s.value=!1)},{default:a(()=>t[9]||(t[9]=[i(" 确定 ")])),_:1})]),default:a(()=>[d("div",null,[l(o(x))])]),_:1},8,["modelValue"])]),_:1}))}}),T=k(G,[["__scopeId","data-v-77ce029c"]]),_=`<template>
  <div>
    <ver-button @click="dialogVisible = true">点击打开对话框</ver-button>
