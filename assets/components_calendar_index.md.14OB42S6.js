import{f as p}from"./chunks/theme.uDsgHOqn.js";import{d as h,B as C,b as v,o as i,w as r,j as t,G as n,t as c,a as d,k as o,p as y,c as f,e as _,n as g,aw as D}from"./chunks/framework.BrE8sLAv.js";import{Q as m}from"./chunks/index.CmMjEtxm.js";const z=`<template>
...
<\/script>
`,W={class:"custom-cell"},T={key:0,class:"custom-cell-text"},w=h({__name:"customize",setup(u){const s=y(new Date);return(e,a)=>(i(),v(o(p),{modelValue:s.value,"onUpdate:modelValue":a[0]||(a[0]=l=>s.value=l)},{"date-cell":r(({data:l})=>[t("div",W,[t("div",{class:g(["custom-cell-date",{"is-selected":l.isSelected}])},c(l.day.split("-").slice(2).join("")),3),l.type==="current-month"?(i(),f("div",T,c(l.isSelected?"已选择":"可选"),1)):_("",!0)])]),_:1},8,["modelValue"]))}}),S=`<script lang="ts" setup>
import { VerCalendar } from '@versakit/ui'
import { ref } from 'vue'
