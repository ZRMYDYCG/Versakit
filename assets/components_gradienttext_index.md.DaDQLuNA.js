import{u as l,a as c}from"./chunks/theme.4ot6jhsU.js";import{c as u,o as p,G as t,w as r,a as d,k as a,F as f,p as h,B as T,j as n,as as v}from"./chunks/framework.DSK5FMsA.js";import{Q as b}from"./chunks/index.CWxr9eMF.js";const V=`<template>
  <VerGradientText
...
<\/script>
<style scoped lang="scss"></style>
`,y={__name:"size",setup(m){const s=h("md"),e=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(o,i)=>(p(),u(f,null,[t(a(c),{modelValue:s.value,"onUpdate:modelValue":i[0]||(i[0]=x=>s.value=x),options:e},null,8,["modelValue"]),t(a(l),{size:s.value,type:"success"},{default:r(()=>i[1]||(i[1]=[d(" 哈哈哈哈 ")])),_:1},8,["size"]),t(a(l),{size:24,type:"error"},{default:r(()=>i[2]||(i[2]=[d("哈哈哈哈")])),_:1})],64))}},B=`<template>
