import{g as s,U as p,D as V,H as D}from"./chunks/theme.C6BEB8ch.js";import{d as g,p as m,b as c,o as v,w as a,G as o,k as n,a as i,j as d,_ as h,c as W,B as C,at as k}from"./chunks/framework.CYu56ZLI.js";import{Q as f}from"./chunks/index.B77M7Ljq.js";const y=`<template>
  <ver-row>
...
<\/script>
`,B=g({__name:"header",setup(b){const r=m(!1);return(l,e)=>(v(),c(n(V),null,{default:a(()=>[o(n(s),{onClick:e[0]||(e[0]=t=>r.value=!0)},{default:a(()=>e[2]||(e[2]=[i("点击打开对话框")])),_:1}),o(n(p),{modelValue:r.value,"onUpdate:modelValue":e[1]||(e[1]=t=>r.value=t),closeIcon:"ep:close"},{title:a(()=>e[3]||(e[3]=[d("div",{class:"title"},[d("h4",null,"This is a custom header!")],-1)])),_:1},8,["modelValue"])]),_:1}))}}),Z=`<template>
  <ver-row>
    <ver-button @click="dialogVisible = true">点击打开对话框</ver-button>
