import{y as c,Z as s}from"./chunks/theme.BQa7b3Ic.js";import{d as V,c as p,o as f,G as o,k as l,w as r,a as i,_ as W,B as v,aq as y,j as n}from"./chunks/framework.jWG7FAcU.js";import{Q as b}from"./chunks/index.B5U2ewO1.js";const B=`<template>
  <div>
...
`,_=V({__name:"position",setup(m){const d=()=>{s({title:"title",content:"content",position:"top-left"})},t=()=>{s({title:"title",content:"content"})},a=()=>{s({title:"title",content:"content",position:"bottom-left"})},u=()=>{s({title:"title",content:"content",position:"bottom-right"})};return(h,e)=>(f(),p("div",null,[o(l(c),{onClick:d},{default:r(()=>e[0]||(e[0]=[i("top-left")])),_:1}),o(l(c),{onClick:t},{default:r(()=>e[1]||(e[1]=[i("top-right")])),_:1}),o(l(c),{onClick:a},{default:r(()=>e[2]||(e[2]=[i("bottom-left")])),_:1}),o(l(c),{onClick:u},{default:r(()=>e[3]||(e[3]=[i("bottom-right")])),_:1})]))}}),C=W(_,[["__scopeId","data-v-49e45a40"]]),k=`<template>
  <div>
...
`,T=V({__name:"type",setup(m){const d=()=>{s({title:"title",type:"info",content:"content"})},t=()=>{s({title:"title",type:"success",content:"content"})},a=()=>{s({title:"title",type:"warning",content:"content"})},u=()=>{s({title:"title",type:"error",content:"content"})};return(h,e)=>(f(),p("div",null,[o(l(c),{type:"info",onClick:d},{default:r(()=>e[0]||(e[0]=[i("info")])),_:1}),o(l(c),{type:"success",onClick:t},{default:r(()=>e[1]||(e[1]=[i("success")])),_:1}),o(l(c),{type:"warn",onClick:a},{default:r(()=>e[2]||(e[2]=[i("warning")])),_:1}),o(l(c),{type:"error",onClick:u},{default:r(()=>e[3]||(e[3]=[i("error")])),_:1})]))}}),Z=W(T,[["__scopeId","data-v-b1b85772"]]),A=`<template>
  <div>
