import{c,w as o}from"./chunks/theme.4ot6jhsU.js";import{d as m,c as i,o as l,G as n,k as s,w as r,j as t,_ as x,B as v,a}from"./chunks/framework.DSK5FMsA.js";import{Q as u}from"./chunks/index.CWxr9eMF.js";const w=`<script setup lang="ts">
...
`,b={class:"carousel-wrapper"},f=m({__name:"slot",setup(p){return(d,e)=>(l(),i("div",b,[n(s(c),{autoplay:!0,interval:3e3,"show-arrows":!0,"show-indicators":!0,direction:"horizontal",trigger:"hover"},{default:r(()=>[n(s(o),{width:"1200px",height:"600px"},{default:r(()=>e[0]||(e[0]=[t("div",{class:"custom-slide"},[t("h3",null,"自定义内容 1"),t("p",null,"这是一个使用 slot 的示例")],-1)])),_:1}),n(s(o),{width:"1200px",height:"600px"},{default:r(()=>e[1]||(e[1]=[t("div",{class:"custom-slide"},[t("h3",null,"自定义内容 2"),t("p",null,"你可以放置任何内容")],-1)])),_:1})]),_:1})]))}}),g=x(f,[["__scopeId","data-v-f43b5e0e"]]),C=`<script setup lang="ts">
import { VerCarousel, VerCarouselItem } from '@versakit/ui'
<\/script>
