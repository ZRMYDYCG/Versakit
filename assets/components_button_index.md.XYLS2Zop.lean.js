import{z as u,N as i,a as B}from"./chunks/theme.4ot6jhsU.js";import{d as y,b as p,o as s,w as r,G as n,k as l,_ as g,at as D,a5 as V,a as o,p as c,c as w,F as Z,au as z,B as x,as as Y,j as e}from"./chunks/framework.DSK5FMsA.js";import{Q as f}from"./chunks/index.CWxr9eMF.js";const k=`<script setup lang="ts">
...
`,X=y({__name:"icon",setup(v){return(d,t)=>(s(),p(l(i),null,{default:r(()=>[n(l(u),{color:"pink",circle:"",icon:"ep:apple"}),n(l(u),{color:"green",circle:"",icon:"ep:chrome-filled"}),n(l(u),{circle:"",icon:"ep:cold-drink"})]),_:1}))}}),A=g(X,[["__scopeId","data-v-cfcc120d"]]),G=`<script setup lang="ts">
import { VerButton, VerRow } from '@versakit/ui'
<\/script>
...
`,T=y({__name:"ripple",setup(v){return(d,t)=>{const a=D("ripple");return s(),p(l(i),{class:"mb-4"},{default:r(()=>[V((s(),p(l(u),{color:"blue-1"},{default:r(()=>t[0]||(t[0]=[o("按 钮")])),_:1})),[[a]]),V((s(),p(l(u),{color:"blue-2"},{default:r(()=>t[1]||(t[1]=[o("按 钮")])),_:1})),[[a]]),V((s(),p(l(u),{color:"blue-3"},{default:r(()=>t[2]||(t[2]=[o("按 钮")])),_:1})),[[a]]),V((s(),p(l(u),{color:"blue-4"},{default:r(()=>t[3]||(t[3]=[o("按 钮")])),_:1})),[[a]]),V((s(),p(l(u),{color:"blue-5"},{default:r(()=>t[4]||(t[4]=[o("按 钮")])),_:1})),[[a]])]),_:1})}}}),N=g(T,[["__scopeId","data-v-47d698e9"]]),S=`<script setup lang="ts">
import { ref } from 'vue'
