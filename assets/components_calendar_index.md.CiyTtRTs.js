import{d as b,B,b as f,o as i,w as r,j as t,G as a,t as c,a as d,k as s,p as y,c as V,e as z,n as X,a5 as m,at as A,a6 as p}from"./chunks/framework.DgG_RYdR.js";import{n as C}from"./chunks/theme.BN5ATFS7.js";import{d as h,f as v}from"./chunks/index.CrgVH6Ra.js";const Y=`<template>
...
`,Z={class:"custom-header"},W={class:"custom-header-title"},T=b({__name:"header",setup(u){return(o,n)=>{const e=B("VerButton");return i(),f(s(C),{ref:"calendar"},{header:r(({date:l,prevMonth:x,nextMonth:_,prevYear:g,nextYear:k,today:D})=>[t("div",Z,[t("span",W,c(l.getFullYear())+"年"+c(l.getMonth()+1)+"月 ",1),a(e,{type:"primary",size:"sm",onClick:g},{default:r(()=>n[0]||(n[0]=[d("上一年")])),_:2},1032,["onClick"]),a(e,{type:"primary",size:"sm",onClick:k},{default:r(()=>n[1]||(n[1]=[d("下一年")])),_:2},1032,["onClick"]),a(e,{type:"primary",size:"sm",onClick:x},{default:r(()=>n[2]||(n[2]=[d(" 上个月 ")])),_:2},1032,["onClick"]),a(e,{type:"primary",size:"sm",onClick:D},{default:r(()=>n[3]||(n[3]=[d("今天")])),_:2},1032,["onClick"]),a(e,{type:"primary",size:"sm",onClick:_},{default:r(()=>n[4]||(n[4]=[d(" 下个月 ")])),_:2},1032,["onClick"]),a(e,{type:"primary",size:"sm",onClick:k},{default:r(()=>n[5]||(n[5]=[d("下一年")])),_:2},1032,["onClick"])])]),_:1},512)}}}),w=`<template>
