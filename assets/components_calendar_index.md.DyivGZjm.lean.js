import{A as p}from"./chunks/theme.TceoO1wW.js";import{d as h,B as C,b as v,o as i,w as r,j as t,G as n,t as c,a as d,k as o,p as y,c as f,e as _,n as g,at as D}from"./chunks/framework.CsNVs6Ia.js";import{Q as m}from"./chunks/index.CT2k1i2x.js";const z=`<template>
...
`,A={class:"custom-header"},X={class:"custom-header-title"},Y=h({__name:"header",setup(u){return(s,e)=>{const a=C("VerButton");return i(),v(o(p),{ref:"calendar"},{header:r(({date:l,prevMonth:k,nextMonth:B,prevYear:V,nextYear:b,today:x})=>[t("div",A,[t("span",X,c(l.getFullYear())+"年"+c(l.getMonth()+1)+"月 ",1),n(a,{type:"primary",size:"sm",onClick:V},{default:r(()=>e[0]||(e[0]=[d("上一年")])),_:2},1032,["onClick"]),n(a,{type:"primary",size:"sm",onClick:b},{default:r(()=>e[1]||(e[1]=[d("下一年")])),_:2},1032,["onClick"]),n(a,{type:"primary",size:"sm",onClick:k},{default:r(()=>e[2]||(e[2]=[d(" 上个月 ")])),_:2},1032,["onClick"]),n(a,{type:"primary",size:"sm",onClick:x},{default:r(()=>e[3]||(e[3]=[d("今天")])),_:2},1032,["onClick"]),n(a,{type:"primary",size:"sm",onClick:B},{default:r(()=>e[4]||(e[4]=[d(" 下个月 ")])),_:2},1032,["onClick"]),n(a,{type:"primary",size:"sm",onClick:b},{default:r(()=>e[5]||(e[5]=[d("下一年")])),_:2},1032,["onClick"])])]),_:1},512)}}}),Z=`<template>
