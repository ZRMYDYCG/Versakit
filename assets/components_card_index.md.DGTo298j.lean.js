import{S as o,N as x,z as W}from"./chunks/theme.4ot6jhsU.js";import{d as v,b as w,o as s,w as n,G as a,k as l,a as d,_ as c,c as i,j as e,F as h,C as y,t as f,B as b,as as B}from"./chunks/framework.DSK5FMsA.js";import{Q as m}from"./chunks/index.CWxr9eMF.js";const _=`<template>
  <ver-row>
...
<\/script>
`,z=v({__name:"template",setup(u){return(p,t)=>(s(),i("div",null,[a(l(o),null,{header:n(()=>t[0]||(t[0]=[e("div",null,[e("span",null,"头部")],-1)])),footer:n(()=>t[1]||(t[1]=[e("div",null,[e("span",null,"底部")],-1)])),default:n(()=>[t[2]||(t[2]=e("div",null,[e("span",null,"内容")],-1))]),_:1})]))}}),A=`<template>
  <div>
    <ver-card>
...
`,D=v({__name:"simple",setup(u){return(p,t)=>(s(),i("div",null,[a(l(o),null,{default:n(()=>[(s(),i(h,null,y(4,r=>e("div",{key:r,class:"text item"},f("List item "+r),1)),64))]),_:1})]))}}),N=c(D,[["__scopeId","data-v-a67c8d89"]]),T=`<template>
  <div>
    <ver-card>
      <template #header>
