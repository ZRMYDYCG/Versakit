import{G as s,W as d}from"./chunks/theme.tWKbjlo-.js";import{d as v,b as V,o as c,w as e,G as l,k as t,j as n,_ as p,c as x,F as m,C,B as W,as as f,a}from"./chunks/framework.D0tLR0bK.js";import{Q as u}from"./chunks/index.BULxsYUw.js";const y=`<template>
  <ver-row :gutter="4">
...
`,X=v({__name:"gutter",setup(b){return(i,o)=>(c(),V(t(d),{gutter:20},{default:e(()=>[(c(),x(m,null,C(4,r=>l(t(s),{span:6,key:r},{default:e(()=>o[0]||(o[0]=[n("div",{class:"col-box"},null,-1)])),_:2},1024)),64))]),_:1}))}}),A=p(X,[["__scopeId","data-v-781d3b1f"]]),D=`<template>
  <VerRow class="mb-4">
