import{C as l,k as c}from"./chunks/theme.uDsgHOqn.js";import{c as u,o as p,G as t,w as r,a as d,k as a,F as f,p as h,B as T,j as n,aw as v}from"./chunks/framework.BrE8sLAv.js";import{Q as b}from"./chunks/index.CmMjEtxm.js";const V=`<template>
  <VerGradientText
...
<\/script>
<style scoped lang="scss"></style>
`,y={__name:"size",setup(m){const s=h("md"),e=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(i,o)=>(p(),u(f,null,[t(a(c),{modelValue:s.value,"onUpdate:modelValue":o[0]||(o[0]=x=>s.value=x),options:e},null,8,["modelValue"]),t(a(l),{size:s.value,type:"success"},{default:r(()=>o[1]||(o[1]=[d(" 哈哈哈哈 ")])),_:1},8,["size"]),t(a(l),{size:24,type:"error"},{default:r(()=>o[2]||(o[2]=[d("哈哈哈哈")])),_:1})],64))}},C=`<template>
