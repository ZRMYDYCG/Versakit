import{m as l,y as b}from"./chunks/theme.CQgGDvlX.js";import{d as f,p,c as u,o as d,G as e,j as s,k as t,_ as y,w as o,a as i,B as g}from"./chunks/framework.DWhRHyQt.js";import{Q as m}from"./chunks/index.80Y4sWw1.js";const B=`<template>
  <div>
...
`,Z=f({__name:"circle",setup(v){const r=p(75);return(n,c)=>(d(),u("div",null,[e(t(l),{type:"circle",percent:r.value},null,8,["percent"]),e(t(l),{type:"circle",percent:r.value,status:"success"},null,8,["percent"]),e(t(l),{type:"circle",percent:r.value,status:"error"},null,8,["percent"])]))}}),C=y(Z,[["__scopeId","data-v-06a138a2"]]),W=`<template>
  <div>
    <VerProgress :percent />
