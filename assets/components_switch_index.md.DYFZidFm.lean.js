import{k as w,a2 as f}from"./chunks/theme.uDsgHOqn.js";import{d as h,p as m,c as V,o as p,G as n,k as o,_ as W,b as B,B as c,j as e,a as t,w as i}from"./chunks/framework.BrE8sLAv.js";import{Q as b}from"./chunks/index.CmMjEtxm.js";const C=`<template>
  <div>
...
`,k=h({__name:"size",setup(v){const s=m(!1),l=m("md"),a=[{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(d,u)=>(p(),V("div",null,[n(o(w),{modelValue:l.value,"onUpdate:modelValue":u[0]||(u[0]=r=>l.value=r),options:a},null,8,["modelValue"]),n(o(f),{size:l.value,modelValue:s.value,"onUpdate:modelValue":u[1]||(u[1]=r=>s.value=r)},null,8,["size","modelValue"])]))}}),x=W(k,[["__scopeId","data-v-90fbdb74"]]),z=`<template>
