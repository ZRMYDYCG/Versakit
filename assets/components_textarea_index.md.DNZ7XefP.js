import{T as m}from"./chunks/theme.TceoO1wW.js";import{d as h,p as x,b as c,o as s,k as l,_ as b,B as v,c as f,j as t,G as d,at as Z,a as r,w as n}from"./chunks/framework.CsNVs6Ia.js";import{Q as u}from"./chunks/index.CT2k1i2x.js";const W=`<template>
...
`,_=h({__name:"maxlength",setup(i){const o=x("");return(e,a)=>(s(),c(l(m),{modelValue:o.value,"onUpdate:modelValue":a[0]||(a[0]=p=>o.value=p),maxlength:10,placeholder:"请输入内容"},null,8,["modelValue"]))}}),X=b(_,[["__scopeId","data-v-1a6b3033"]]),y=`<template>
...
`,B=h({__name:"disabled",setup(i){return(o,e)=>(s(),c(l(m),{disabled:"",placeholder:"请输入内容"}))}}),V=b(B,[["__scopeId","data-v-b165ddb4"]]),T=`<template>
