import{c as u,o as p,G as t,w as n,a as d,k as a,F as h,p as T,B as c,j as s,a5 as f,at as g,a6 as b}from"./chunks/framework.DgG_RYdR.js";import{l as i,p as G}from"./chunks/theme.BN5ATFS7.js";import{d as x,f as v}from"./chunks/index.CrgVH6Ra.js";const y=`<template>
  <VerGradientText
...
<\/script>
<style scoped lang="scss"></style>
`,_={__name:"size",setup(m){const l=T("md"),r=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(e,o)=>(p(),u(h,null,[t(a(G),{modelValue:l.value,"onUpdate:modelValue":o[0]||(o[0]=V=>l.value=V),options:r},null,8,["modelValue"]),t(a(i),{size:l.value,type:"success"},{default:n(()=>o[1]||(o[1]=[d(" 哈哈哈哈 ")])),_:1},8,["size"]),t(a(i),{size:24,type:"error"},{default:n(()=>o[2]||(o[2]=[d("哈哈哈哈")])),_:1})],64))}},D=`<template>
