import{g as s,t as i}from"./chunks/theme.C6BEB8ch.js";import{p as g,b as c,o as p,w as a,G as n,k as r,a as l,_ as f,c as v,F as h,B as b,at as _,j as e}from"./chunks/framework.CYu56ZLI.js";import{Q as B}from"./chunks/index.B77M7Ljq.js";const y=`<template>
...
<\/script>
`,V={__name:"number",setup(m){const d=g(95),t=()=>{d.value++};return(u,o)=>(p(),c(r(i),{type:"number",value:d.value},{default:a(()=>[n(r(s),{onClick:o[0]||(o[0]=W=>t())},{default:a(()=>o[1]||(o[1]=[l("点我增加")])),_:1})]),_:1},8,["value"]))}},k=`<template>
  <VerBadge>
