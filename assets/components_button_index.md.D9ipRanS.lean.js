import{g as u,D as i,p as B}from"./chunks/theme.C6BEB8ch.js";import{d as y,b,o as s,w as r,G as n,k as l,_ as V,au as D,a5 as g,a as o,p as c,c as w,F as Z,av as z,B as x,at as Y,j as e}from"./chunks/framework.CYu56ZLI.js";import{Q as f}from"./chunks/index.B77M7Ljq.js";const k=`<script setup lang="ts">
...
`,X=y({__name:"icon",setup(v){return(d,t)=>(s(),b(l(i),null,{default:r(()=>[n(l(u),{color:"pink",circle:"",icon:"ep:apple"}),n(l(u),{color:"green",circle:"",icon:"ep:chrome-filled"}),n(l(u),{circle:"",icon:"ep:cold-drink"})]),_:1}))}}),A=V(X,[["__scopeId","data-v-cfcc120d"]]),G=`<script setup lang="ts">
import { VerButton, VerRow } from '@versakit/ui'
<\/script>
...
`,T=y({__name:"ripple",setup(v){return(d,t)=>{const a=D("ripple");return s(),b(l(i),{class:"mb-4"},{default:r(()=>[g((s(),b(l(u),{color:"blue-1"},{default:r(()=>t[0]||(t[0]=[o("按 钮")])),_:1})),[[a]]),g((s(),b(l(u),{color:"blue-2"},{default:r(()=>t[1]||(t[1]=[o("按 钮")])),_:1})),[[a]]),g((s(),b(l(u),{color:"blue-3"},{default:r(()=>t[2]||(t[2]=[o("按 钮")])),_:1})),[[a]]),g((s(),b(l(u),{color:"blue-4"},{default:r(()=>t[3]||(t[3]=[o("按 钮")])),_:1})),[[a]]),g((s(),b(l(u),{color:"blue-5"},{default:r(()=>t[4]||(t[4]=[o("按 钮")])),_:1})),[[a]])]),_:1})}}}),N=V(T,[["__scopeId","data-v-47d698e9"]]),S=`<script setup lang="ts">
import { ref } from 'vue'
...
`,J=y({__name:"size",setup(v){const d=c("md"),t=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(a,p)=>(s(),w("div",null,[n(l(B),{modelValue:d.value,"onUpdate:modelValue":p[0]||(p[0]=C=>d.value=C),options:t},null,8,["modelValue"]),n(l(u),{class:"mx-2",color:"blue-5",size:d.value},{default:r(()=>p[1]||(p[1]=[o(" 主要按钮 ")])),_:1},8,["size"])]))}}),L=V(J,[["__scopeId","data-v-756bc12e"]]),I=`<script setup lang="ts">
import { VerButton, VerRow } from '@versakit/ui'
<\/script>
...
<\/script>
<style scoped></style>
`,U=y({__name:"style",setup(v){let d=c("primary"),t=c("plain"),a=[{label:"primary",value:"primary"},{label:"success",value:"success"},{label:"error",value:"error"},{label:"warn",value:"warn"},{label:"info",value:"info"}],p=[{label:"ghost",value:"ghost"},{label:"round",value:"round"},{label:"text",value:"text"},{label:"shade",value:"shade"},{label:"full",value:"full"}];return(C,m)=>(s(),w("div",null,[n(l(B),{modelValue:l(d),"onUpdate:modelValue":m[0]||(m[0]=W=>z(d)?d.value=W:d=W),options:l(a)},null,8,["modelValue","options"]),n(l(B),{modelValue:l(t),"onUpdate:modelValue":m[1]||(m[1]=W=>z(t)?t.value=W:t=W),options:l(p)},null,8,["modelValue","options"]),n(l(u),{type:l(d),variant:l(t)},{default:r(()=>m[2]||(m[2]=[o("按 钮")])),_:1},8,["type","variant"])]))}}),M=`<script setup lang="ts">
import { VerButton, VerRow } from '@versakit/ui'
<\/script>
