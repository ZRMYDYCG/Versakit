import { type Ref, nextTick, onBeforeUnmount, ref, unref, watch } from 'vue'
...
let instance: Instance | any = null
const usePopper: any = (
  target: Ref<any>,
  popper: Ref<any>,
  ...
  watch(
    () => [unref(target), unref(popper)],
    ([target, popper], [oldTarget, oldPopper]) => {
