import { r as c } from './chunks/theme.CWxU7uh8.js'
import {
  d as U,
  o,
  b,
...
`,
  k = U({
    ...
    setup(i) {
      ...
      return (d, u) => (o(), b(n(c), { border: '', data: l, columns: e }))
    },
  }),
  y = `<template>\r
...
`,
  g = U({
    ...
    setup(i) {
      ...
      return (d, u) => (o(), b(n(c), { stripe: '', data: l, columns: e }))
    },
  }),
  x = `<template>\r
...
export { S as __pageData, _ as default }
